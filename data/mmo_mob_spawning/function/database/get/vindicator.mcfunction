...
$execute if data storage minecraft:mmo_mobs vindicator[$(rng_vindicator)] run function mmo_mob_spawning:particles
...
$data modify entity @s Health set from storage minecraft:mmo_mobs vindicator[$(rng_vindicator)].attributes[{id:"minecraft:max_health"}].base

# [Load] [Attributes [Scaling, Atk, Armor]]
$data modify entity @s attributes[{id:"minecraft:scale"}].base set from storage minecraft:mmo_mobs vindicator[$(rng_vindicator)].attributes[{id:"minecraft:scale"}].base
$data modify entity @s attributes[{id:"minecraft:attack_damage"}].base set from storage minecraft:mmo_mobs vindicator[$(rng_vindicator)].attributes[{id:"minecraft:attack_damage"}].base
$data modify entity @s attributes[{id:"minecraft:armor"}].base set from storage minecraft:mmo_mobs vindicator[$(rng_vindicator)].attributes[{id:"minecraft:armor"}].base