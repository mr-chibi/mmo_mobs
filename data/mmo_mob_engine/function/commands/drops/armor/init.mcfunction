# [Updated Armor Slots]:
execute if items entity @s weapon.mainhand #mmo_mob_engine:boots store result entity @e[type=#mmo_mob_engine:mobs,distance=0..5,sort=nearest,limit=1] ArmorDropChances[0] float 1 run function mmo_mob_engine:commands/drops/armor/boots
execute if items entity @s weapon.mainhand #mmo_mob_engine:leggings store result entity @e[type=#mmo_mob_engine:mobs,distance=0..5,sort=nearest,limit=1] ArmorDropChances[1] float 1 run function mmo_mob_engine:commands/drops/armor/leggings
execute if items entity @s weapon.mainhand #mmo_mob_engine:chestplate store result entity @e[type=#mmo_mob_engine:mobs,distance=0..5,sort=nearest,limit=1] ArmorDropChances[2] float 1 run function mmo_mob_engine:commands/drops/armor/chestplate
execute if items entity @s weapon.mainhand #mmo_mob_engine:helmet store result entity @e[type=#mmo_mob_engine:mobs,distance=0..5,sort=nearest,limit=1] ArmorDropChances[3] float 1 run function mmo_mob_engine:commands/drops/armor/helmet
