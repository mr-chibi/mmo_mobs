...
execute if score @s[tag=mmo_engine_randomize] mmo_mobs_random = @s mmo_mob_rng run function mmo_mob_engine:random/default/nbt with storage minecraft:mmo_mob_id database[0]
