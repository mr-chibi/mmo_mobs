...
#
execute if score @s mmo_get_mob matches 1.. run scoreboard players operation @s mmo_get_page -= @s mmo_get_mob
execute if score @s mmo_get_mob matches 1.. run scoreboard players operation @e[type=minecraft:marker,distance=0..5,tag=mmo_mob_data,sort=nearest,limit=1] mmo_get_page -= @s mmo_get_mob
...
#
function #mmo_mob_engine:get_rows
